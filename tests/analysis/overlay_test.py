...
class TestErase:
    ...
    @mark.parametrize('fc_name, xy_tolerance, count', [
        ...
        param('admin_mp_a', 0.001, 217, marks=mark.slow),
...
class TestIntersect:
    ...
    @mark.parametrize('fc_name, algorithm_option, output_option, feature_count, throws', [
        ...
        param('admin_mp_a', AlgorithmOption.PAIRWISE, OutputTypeOption.LINE, 0, False, marks=mark.slow),
        ...
        param('admin_mp_a', AlgorithmOption.CLASSIC, OutputTypeOption.POINT, 358, False, marks=mark.slow),
