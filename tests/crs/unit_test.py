...
class TestGetUnitConversion:
    ...
    def test_length(self):
        ...
        assert approx(values, abs=0.000001) == [
            1000.0, 1.0, 1609.344, 1852.0, 0.9144, 0.3048, 1609.344, 1609.344,
            0.9144, 0.3048, 1609.34721869444, 1853.248, 0.9144018288036576,
            0.304800609601219, 1609.34721869444,
            0.9144018288036576, 0.304800609601219]
...
def test_unit_factory_valid(value, expected, meters):
    ...
    if meters is not None:
        assert approx(result.meters, abs=0.1) == meters
