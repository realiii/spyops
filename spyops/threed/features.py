...
def generate_points_along_3d_lines(
    ...
    as measured along the lines in 3D.
    ...
    90 percent of the 3D line length.
    ...
    * Units for text values can be mixed across features and within the same
    ...
    if placement_option == PlacementOption.PERCENTAGE:
        cls = QueryGeneratePointsAlong3DLinesPercentage
    elif placement_option == PlacementOption.FIELD:
        cls = QueryGeneratePointsAlong3DLinesField
    else:
        cls = QueryGeneratePointsAlong3DLinesDistance
