...
class AbstractFeatureClassQuery(AbstractElementQuery, metaclass=ABCMeta):
    ...
    def __init__(self, element: FeatureClass, *, where_clause: str = EMPTY, xy_tolerance: XY_TOL = None) -> None: ...
...
class AbstractSourceQuery(AbstractFeatureClassQuery, metaclass=ABCMeta):
    ...
    def __init__(self, source: FeatureClass, target: FeatureClass, *, where_clause: str = EMPTY, xy_tolerance: XY_TOL = None) -> None: ...
...
class AbstractSourceUpdateQuery(IntermediateTableContextMixin, AbstractSourceQuery):
    def __init__(self, source: FeatureClass, where_clause: str = EMPTY, xy_tolerance: XY_TOL = None) -> None: ...
    @property
    ...
    def _make_update_from(element_name: str, key_name: str, field_names: NAMES,
                          from_name: str, from_key_name: str, from_field_names: NAMES) -> str: ...
