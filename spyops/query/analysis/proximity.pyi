...
class AbstractQueryBufferDissolve(AbstractQueryDissolve, metaclass=ABCMeta):
    ...
    def _dissolve_and_transform(self, geoms: ndarray, ids: ndarray, ) -> dict[int, MultiPolygon]: ...
    def _dissolve_polygons(self, geoms: ndarray, ids: ndarray,) -> tuple[list, ndarray]: ...
    def _get_units(self, features: list[tuple],) -> tuple[list[LinearUnit | DecimalDegrees | None], ndarray]: ...
    def _get_distances(self, geoms: ndarray, units: list[LinearUnit | DecimalDegrees | None],) -> tuple[ndarray, ndarray]: ...
    def _get_distances_broadcast(self, geoms: ndarray, unit: LinearUnit | DecimalDegrees,) -> tuple[ndarray, ndarray]: ...
    @property
...
class QueryBufferDissolveNone(AbstractQueryBufferDissolve):
    ...
    def _from_field(self, sql: str, size: int, steps: int,) -> Generator[dict[int, MultiPolygon], None, None]: ...
    def _from_distance(self, sql: str, size: int, steps: int,) -> Generator[dict[int, MultiPolygon], None, None]: ...
    def _dissolve_polygons(self, geoms: ndarray, ids: ndarray,) -> tuple[ndarray, ndarray]: ...
