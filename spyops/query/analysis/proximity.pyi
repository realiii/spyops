...
class AbstractQueryBufferDissolve(AbstractQueryDissolve, UnitTypeMixin,
    ...
    def _get_units(self, features: list[tuple],) -> tuple[list[UNIT | None], ndarray]: ...
    def _get_distances(self, geoms: ndarray, units: list[UNIT | None],) -> tuple[ndarray, ndarray]: ...
    def _get_distances_broadcast(self, geoms: ndarray, unit: UNIT,) -> tuple[ndarray, ndarray]: ...
    @property
...
class QueryMultipleBuffer(AbstractQueryBufferDissolve):
    ...
    def _distances_labels_overlap(self, unit: Type[UNIT],) -> tuple[list[UNIT], list[str]]: ...
    def _distance_labels_sans(self, unit: Type[UNIT],) -> tuple[list[UNIT], list[str]]: ...
    @staticmethod
