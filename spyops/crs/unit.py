...
UNIT_CLASS_MAP: dict[str, Type['LinearUnit'] | Type['DecimalDegrees']] = {
    ...
    'feet_int': FeetInternational,
    'foot_int': FeetInternational,
    ...
    'miles_int': MilesInternational,
    'mile_int': MilesInternational,
    ...
    'yards_int': YardsInternational,
    'yard_int': YardsInternational,
